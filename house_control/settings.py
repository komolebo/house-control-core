"""
Django settings for house_control project.
...
SECRET_KEY = 'xg$=q3phnjd($^6!pxutt*mxq23z9_=tx)*x@xb5kw6qk*99k@'
...
ROOT_URLCONF = 'house_control.urls'
...
THREAD__FRONTIER_APP = True
THREAD__UPDATE_APP = True

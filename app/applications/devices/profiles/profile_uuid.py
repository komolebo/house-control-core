class ServiceUuid:
    ...
    TAMPER = 0x1150
    # RESET = 0xFFD0
    RESET = bytes([0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xB0, 0x00, 0x40, 0x51, 0x04, 0xD0, 0xFF, 0x00, 0xF0])
    OAD = bytes([0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xB0, 0x00, 0x40, 0x51, 0x04, 0xC0, 0xFF, 0x00, 0xF0])
...
# Generic device UUIDs
    ...
    SOFTWARE_REVISION_UUID = UuidData(0x2A28, 23)
    # OAD_START_UUID = 0xFFD1
    OAD_RESET_UUID = bytes([0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xB0, 0x00, 0x40, 0x51, 0x04, 0xD1, 0xFF, 0x00, 0xF0])
    # OAD_SERVICE_UUID = bytes([0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xB0, 0x00, 0x40, 0x51, 0x04, 0xC0, 0xFF, 0x00, 0xF0])
